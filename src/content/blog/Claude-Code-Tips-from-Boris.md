...
featured: false
draft: false
description: Claude Code tips from Boris
pubDatetime: 2026-02-17T10:00:00Z
title: Claude Code Tips from Boris Cherny
tags:
  - AI
  - claude
---
...
4/ Our team shares a single [http://CLAUDE.md](https://t.co/pp5TJkWmFE) for the Claude Code repo. We check it into git, and the whole team contributes multiple times a week. Anytime we see Claude do something incorrectly we add it to the [http://CLAUDE.md](https://t.co/pp5TJkWmFE), so Claude knows not to do it next time. Other teams maintain their own [http://CLAUDE.md](https://t.co/pp5TJkWmFE)'s. It is each team's job to keep theirs up to date.

5/ During code review, I will often tag @.claude on my coworkers' PRs to add something to the [http://CLAUDE.md](https://t.co/v4FOLUBHz9) as part of the PR. We use the Claude Code Github action (/install-github-action) for this. It's our version of [@danshipper](https://x.com/danshipper) 's Compounding Engineering
