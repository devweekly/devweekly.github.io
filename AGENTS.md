...
| 2026-07-29 | repo-research-v2: 新增 gated-checks.mjs — LLM-powered quality gate 验证模块，使用 llm-runner.mjs 调用 OpenCode CLI 执行 6 个门禁检查（center_identified / alternatives_considered / counterexamples_found / model_challenged / depth_gate / maintainer_gate）；CLI 入口：node gated-checks.mjs <context.json> <report.md> | @agents-maintainer |
