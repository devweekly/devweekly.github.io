...
> **来源**: [github.com/corca-ai/awesome-llm-security](https://github.com/corca-ai/awesome-llm-security)
>
> 精选的 LLM 安全工具、文档和项目合集。
...
- [LLM Evaluation metrics, framework, and checklist](https://repello.ai/blog/llm-evaluation-metrics-frameworks-and-checklist)
...
- [0din GenAI Bug Bounty (Mozilla)](https://0din.ai/): The 0Day Investigative Network is a bug bounty program focusing on flaws within GenAI models. Vulnerability classes include Prompt Injection, Training Data Poisoning, DoS, and more.
...
- [LLM Security Problems at DEFCON31 Quals](https://github.com/Nautilus-Institute/quals-2023/tree/main/pawan_gupta)
