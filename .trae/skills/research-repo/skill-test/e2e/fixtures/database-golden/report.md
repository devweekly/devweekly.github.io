# Research Report: synthetic-database-TJRjUq

## Executive Summary

synthetic-database-TJRjUq is analyzed with deterministic pipeline. Detected signals: hasParser, hasLexer, hasSQL.
Findings: 16. README contradictions: 1.

## Top Claims

# Evidence Brief: synthetic-database-TJRjUq
...
| Dimension | Value |
|-----------|-------|
| Repository | synthetic-database-TJRjUq (package: synthetic-db) |
...
|---------|-----------|------------|------------------|
| Factory | 1 | 0.6 | SQLParser (factory methods: buildAST) |
