# Research Report: synthetic-database-cgqzSQ

## Executive Summary

synthetic-database-cgqzSQ is analyzed with deterministic pipeline. Detected signals: hasParser, hasLexer, hasSQL.
Findings: 16. README contradictions: 1.

## Top Claims

# Evidence Brief: synthetic-database-cgqzSQ
...
| Dimension | Value |
|-----------|-------|
| Repository | synthetic-database-cgqzSQ (package: synthetic-db) |
