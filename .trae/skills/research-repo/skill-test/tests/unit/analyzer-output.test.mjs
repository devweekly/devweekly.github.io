...
function extractJson(stdout) {
  // Scan stdout from the end to find the last balanced top-level JSON object or array.
  // This handles commands that emit markdown/progress before the JSON payload.
