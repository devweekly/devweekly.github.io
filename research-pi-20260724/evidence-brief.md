...
**Tools**: 14 detected
  By framework: schema-first (11), script-tool (3)
  Sample tools:
  - [schema-first] `pi-ai-custom-headers` — `packages/ai/src/api/bedrock-converse-stream.ts`
  - [schema-first] `lookup` — `packages/ai/test/anthropic-eager-tool-input-compat.test.ts`
  - [schema-first] `base_tool` — `packages/ai/test/deferred-tools.test.ts`
  - [schema-first] `late_tool` — `packages/ai/test/deferred-tools.test.ts`
  - [schema-first] `Read` — `packages/ai/test/deferred-tools.test.ts`
  - [schema-first] `lookup` — `packages/ai/test/fireworks-models.test.ts`
  - [schema-first] `ping` — `packages/ai/test/openai-completions-tool-choice.test.ts`
  - [schema-first] `read` — `packages/ai/test/openai-completions-tool-choice.test.ts`

**Design archetype** (derived):
  - Tools/Prompts ratio: 0.2 → prompt-heavy design (capabilities primarily instruction-driven)
...
1. `packages/coding-agent/examples/README.md` — README (+50); examples (+30)
2. `packages/coding-agent/examples/extensions/README.md` — README (+50); examples (+30)
3. `packages/coding-agent/examples/extensions/doom-overlay/README.md` — README (+50); examples (+30)
4. `packages/coding-agent/examples/extensions/plan-mode/README.md` — README (+50); examples (+30)
5. `packages/coding-agent/examples/extensions/subagent/README.md` — README (+50); examples (+30)
6. `packages/coding-agent/examples/sdk/README.md` — README (+50); examples (+30)
7. `packages/coding-agent/examples/extensions/claude-rules.ts` — examples (+30); entrypoint (+30)
8. `packages/coding-agent/examples/extensions/commands.ts` — examples (+30); entrypoint (+30)
9. `packages/coding-agent/examples/extensions/custom-provider-anthropic/index.ts` — examples (+30); entrypoint (+30)
10. `packages/coding-agent/examples/extensions/custom-provider-gitlab-duo/index.ts` — examples (+30); entrypoint (+30)
